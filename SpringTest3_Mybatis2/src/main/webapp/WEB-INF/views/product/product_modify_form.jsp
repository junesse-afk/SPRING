...
<body>
	<div align="center">
		...
		<form action="productModify" method="post">
			<input type="text" name="product_id" placeholder="상품번호" value="${product.product_id }" readonly="readonly"><br>
			...
			<input type="file" name="product_img"><br>(현재 업로드 파일: ${product.product_img })<br>
